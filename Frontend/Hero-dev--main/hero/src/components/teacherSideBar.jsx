...
import { TSidebarData } from "./teacherSidebarData";
        ...
        >
            ...
            <div className="sidebar mt-5">
                <ul className="sidebarList">
                    {TSidebarData.map((val, key) => ( // Use parentheses instead of curly braces
...
export default TSidebar; // Corrected component name
